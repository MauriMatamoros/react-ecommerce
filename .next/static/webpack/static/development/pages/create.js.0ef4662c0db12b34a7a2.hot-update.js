...
/* harmony import */ var _utils_catchErrors__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_utils_catchErrors__WEBPACK_IMPORTED_MODULE_9__);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 17:
              ...
              _utils_catchErrors__WEBPACK_IMPORTED_MODULE_9___default()(_context2.t0, setError);
...
var catchErrors = function catchErrors(error, displayError) {
  var errorMessage;

  if (error.response) {
    // The request was made and the server responded with a server code above 2XX
    errorMessage = error.response.data;
    console.log('Error response', errorMessage); // Cloudinary image uploads fails
...
//# sourceMappingURL=create.js.0ef4662c0db12b34a7a2.hot-update.js.map